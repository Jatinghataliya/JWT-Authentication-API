...
import { Plus, ChevronLeft, ChevronRight, Lock, Unlock, UserX, UserCheck, Trash2, ShieldOff, Search } from 'lucide-react'
...
export default function UsersPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['users', page],
    queryFn: () => usersApi.getPaged(page, 20),
  })
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">{data?.totalElements ?? 0} total accounts</p>
        </div>
